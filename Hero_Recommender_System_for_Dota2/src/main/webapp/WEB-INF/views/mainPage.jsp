...
<body>
	...
	<div id="mainpage">
		...
		<div align="center">
			<h1 class="Three-Dee">Are you new player of Dota2?</h1>
		</div>
		<div class="round-parent">
			<div class="round-button">
				<div class="round-button-circle">
					<a id="yesbutton" href="#0" class="round-button"
						title="Recommender heros based on your pre-match records!">Yes</a>
				</div>
			</div>
			<div
			...
			<div class="round-button">
				<div class="round-button-circle">
					<a href="http://example.com" class="round-button"
						title="Choose your favorite hero type!">No</a>
				</div>
			</div>
		</div>
		<div class="cd-user-modal">
			<div class="cd-user-modal-container">
				<div class="cd-inputid">
					...
					<form:form class="cd-form" id="accform"
						action="/Recommender/AccountIdValid" method="post"
						modelAttribute="player">
						<table style="margin: 0 auto;">
							<tr>
								<td>Please enter your account ID:</td>
								<td><form:input id="accountid" path="playerId"
										name="accountid" type="text"
										style="padding:5px;margin-left:15px;" /></td>
							</tr>
							<tr>
	...
	<footer>Copyright 2016 Zhang&Mao </footer>
